...
const partnerLogos = [
  ...
  { name: "MCS", src: new URL("../../assets/mcs.webp", import.meta.url).href },
  {
    ...
    src: new URL("../../assets/Gas Safe Registered.png", import.meta.url).href,
  },
  { name: "NFRC", src: new URL("../../assets/NFRC.png", import.meta.url).href },
  {
    name: "NICEIC",
    src: new URL("../../assets/niceic.png", import.meta.url).href,
  },
  { name: "ICO", src: new URL("../../assets/ico.png", import.meta.url).href },
  {
    name: "safecontractor",
    src: new URL("../../assets/safecontractor.webp", import.meta.url).href,
  },
  {
    name: "constructionline",
    src: new URL("../../assets/constructionline.png", import.meta.url).href,
  },
];
